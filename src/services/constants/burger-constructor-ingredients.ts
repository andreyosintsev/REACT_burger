...
export const CONSTRUCTOR_SWAP_INGREDIENTS:   'CONSTRUCTOR_SWAP_INGREDIENTS'   = 'CONSTRUCTOR_SWAP_INGREDIENTS';
export const CONSTRUCTOR_LOAD_INGREDIENTS:   'CONSTRUCTOR_LOAD_INGREDIENTS'   = 'CONSTRUCTOR_LOAD_INGREDIENTS';